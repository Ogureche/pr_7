        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(service.title, style: TextStyle(fontFamily: 'Montserrat', fontSize: 18)), // Название услуги
                Text('Цена: ${service.price}', style: TextStyle(fontFamily: 'Montserrat'),), // Цена услуги
                Text('Пациент: ${service.quantity}', style: TextStyle(fontFamily: 'Montserrat'),), // Количество
              ],
            ),
          ),
          Row(
